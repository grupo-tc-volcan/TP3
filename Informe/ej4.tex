...
\begin{figure}[H]
	...
	\caption{Ganancia en modo diferencial}
...
\begin{figure}[H]
	...
	\caption{Ganancia en modo com\'un}
   	\label{fig:EJ4_commodegain}
\end{figure}

Cabe resaltar que el circuito fue excitado con una se\~nal de iguales caracter\'isticas que en el caso de la ganancia en modo diferencial.
