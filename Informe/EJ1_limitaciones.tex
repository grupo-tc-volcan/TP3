...
\todo{vinmax en funcion de f}
\begin{equation}
	V_{in_{max}}  = 
\label{vin_max}
\end{equation}

\todo{graficar la funcion vin max en funcion de f}
%\begin{figure}[H] %!ht
%	\centering
%	\includegraphics[width=10cm,height=10cm,keepaspectratio]{../EJ1/00GRAFICOS/teoricossr.png}
